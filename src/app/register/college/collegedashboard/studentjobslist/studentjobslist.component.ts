...
@Component({
  selector: 'app-studentjobslist',
  templateUrl: './studentjobslist.component.html',
  styleUrls: ['./studentjobslist.component.scss']
})
export class StudentjobslistComponent implements OnInit {
